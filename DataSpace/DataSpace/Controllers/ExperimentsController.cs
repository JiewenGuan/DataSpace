...
namespace DataSpace.Controllers
{
    public class ExperimentsController : Controller
    {
        ...
        {
            var spaceContext = _context.Experiments.Include(e => e.Author).Include(e => e.LeadIstitution).Include(e => e.Mission);
        ...
        {
            ViewData["AuthorId"] = new SelectList(_context.People, "PersonID", "Affiliation");
        ...
        public async Task<IActionResult> Create([Bind("ExperimentID,DateOfSubmission,EvaluationStatus,AuthorId,Title,TOA,Aim,Objective,Summary,ModuleDrawing,Status,ExperimentDate,FeildOfResearch,SocialEconomicObjective,LeadInstitutionID,MissionID")] Experiment experiment)
        {
            ...
            ViewData["AuthorId"] = new SelectList(_context.People, "PersonID", "Affiliation", experiment.AuthorId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExperimentID,DateOfSubmission,EvaluationStatus,AuthorId,Title,TOA,Aim,Objective,Summary,ModuleDrawing,Status,ExperimentDate,FeildOfResearch,SocialEconomicObjective,LeadInstitutionID,MissionID")] Experiment experiment)
        {
